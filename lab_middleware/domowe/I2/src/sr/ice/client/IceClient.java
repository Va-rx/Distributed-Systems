...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			int x, y;
			short b;
			com.zeroc.Ice.OutputStream iceOut;
			com.zeroc.Ice.InputStream iceIn;
			com.zeroc.Ice.Object.Ice_invokeResult iceRes;
			byte[] inParams;
				...
				try {
					...
					switch (line) {
						case "dynamicAdd":
							x = 50;
							y = 23;
							iceOut = new com.zeroc.Ice.OutputStream(communicator);
							iceOut.startEncapsulation();
							iceOut.writeInt(x);
							iceOut.writeInt(y);
							iceOut.endEncapsulation();
							inParams = iceOut.finished();
							iceRes = obj1.ice_invoke("add", com.zeroc.Ice.OperationMode.Normal, inParams);
							if(iceRes.returnValue) {
								iceIn = new com.zeroc.Ice.InputStream(communicator, iceRes.outParams);
								iceIn.startEncapsulation();
								r = iceIn.readInt();
								iceIn.endEncapsulation();
								System.out.println("RESULT = " + r);
							}
							break;
						case "dynamicSubtract":
							x = 15;
							y = 6;
							iceOut = new com.zeroc.Ice.OutputStream(communicator);
							iceOut.startEncapsulation();
							...
							iceOut.endEncapsulation();
							inParams = iceOut.finished();
							iceRes = obj1.ice_invoke("subtract", com.zeroc.Ice.OperationMode.Normal, inParams);
							if(iceRes.returnValue) {
								iceIn = new com.zeroc.Ice.InputStream(communicator, iceRes.outParams);
								iceIn.startEncapsulation();
								r = iceIn.readInt();
						...
						case "dynamicOp":
							...
							iceOut = new com.zeroc.Ice.OutputStream(communicator);
							iceOut.startEncapsulation();
							iceOut.writeShort(a.a);
							iceOut.writeLong(a.b);
							iceOut.writeFloat(a.c);
							iceOut.writeString(a.d);
							iceOut.writeShort(b);
							iceOut.endEncapsulation();
							inParams = iceOut.finished();
							iceRes = obj1.ice_invoke("op", com.zeroc.Ice.OperationMode.Normal, inParams);
							if(iceRes.returnValue) {
								System.out.println("DONE");
							}
							break;
						case "dynamicOp2":
							Demo.A[] array = new Demo.A[3];
							array[0] = new Demo.A((short) 11, 22, 33.0f, "ala ma kota");
							array[1] = new Demo.A((short) 22, 33, 44.0f, "kot ma ale");
							array[2] = new Demo.A((short) 33, 44, 55.0f, "ala ma ale");
							iceOut = new com.zeroc.Ice.OutputStream(communicator);
							iceOut.startEncapsulation();
							ASequenceHelper.write(iceOut, array);
							iceOut.endEncapsulation();
							inParams = iceOut.finished();
							iceRes = obj1.ice_invoke("op2", com.zeroc.Ice.OperationMode.Normal, inParams);
							if(iceRes.returnValue) {
								System.out.println("DONE");
								iceIn = new com.zeroc.Ice.InputStream(communicator, iceRes.outParams);
								iceIn.startEncapsulation();
								Demo.A result = Demo.A.ice_read(iceIn);
								iceIn.endEncapsulation();
								System.out.println("Result: A(a = " + result.a + ", b = " + result.b + ", c = " + result.c + ", d = " + result.d + ")");
							}
							break;
						case "add":
							r = obj1.add(7, 8);
