...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default A op2(A[] a)
    {
        return op2(a, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default A op2(A[] a, java.util.Map<String, String> context)
    {
        return _iceI_op2Async(a, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<A> op2Async(A[] a)
    {
        return _iceI_op2Async(a, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<A> op2Async(A[] a, java.util.Map<String, String> context)
    {
        return _iceI_op2Async(a, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<A> _iceI_op2Async(A[] iceP_a, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<A> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "op2", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ASequenceHelper.write(ostr, iceP_a);
                 }, istr -> {
                     A ret;
                     ret = A.ice_read(istr);
                     return ret;
