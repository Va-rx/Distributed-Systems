...
public interface Calc extends com.zeroc.Ice.Object
{
    ...
    A op2(A[] a, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_op2(Calc obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        A[] iceP_a;
        iceP_a = ASequenceHelper.read(istr);
        inS.endReadParams();
        A ret = obj.op2(iceP_a, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        A.ice_write(ostr, ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    }
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 6:
            {
                return _iceD_op2(this, in, current);
            }
            case 7:
            {
